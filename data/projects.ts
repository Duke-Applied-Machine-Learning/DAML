...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Builds a multi-label text classification model (the D4 Classifier) that automatically assigns OpenAlex \"Topic\" tags to manuscripts based on abstracts. Trained on a high-precision \"Silver Set\" dataset to predict niche scientific topics.",
    meta: "Sp26",
    team: "Rohan Wilmot, Iurii Beliaev, Mihail Mircheski, Ian Laurence, Charlie Berman, Aashiv Jain",
    slidesUrl: "https://www.canva.com/design/DAHG1sxjEoY/dLVAkUkR2FWOCwfThjmxoQ/edit",
    tier: "standard",
    status: "current",
  },
  {
  ...
  },
  {
    ...
    title: "Liberata – Author Share Estimation",
    hasScreenshot: false,
    imageSrc: "",
    description: "Develops a Softmax/Dirichlet regression model that predicts the exact percentage of contribution each author made to a manuscript based on their CRediT roles. Initially pre-trained on synthetic data with an active training loop for continuous learning.",
    meta: "Sp26",
    team: "Rohan Wilmot, Iurii Beliaev, Mihail Mircheski, Ian Laurence, Charlie Berman, Aashiv Jain",
    slidesUrl: "https://www.canva.com/design/DAHG1sxjEoY/dLVAkUkR2FWOCwfThjmxoQ/edit",
    tier: "standard",
